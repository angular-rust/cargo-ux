...
```
git clone git@github.com:$USER/cargo-ux.git
```

where `$USER` is your GitHub username. Here you're copying the contents of the `cargo-ux` repository on GitHub to your computer.
